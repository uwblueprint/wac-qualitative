      ...
      <div>
        <div className="cardStyle">
          <div className="introText">
            ...
            <p>
              This tool is designed to be used to assess the level of bias that
              is present in dataset. This is designed to assess the level of
              bias prior to analysis. To get a sense of the sources and
              locations of potential bias in your data most completely you’ll
              need the a copy of the survey tool that was used to collect the
              data, the codebook, and the document that tells you how the data
        ...
        <div className="bottomBorder">
          <div className="bottomTextL">
            <h3>Who we are</h3>
            <p>
              We All Count is a project dedicated to equity in data science.
              Read all about the project{" "}
              <a href="https://weallcount.com/">here</a>.
            </p>
          </div>
          <div className="bottomTextM">
            <h3>How Does It Work?</h3>
            <p>
              Want to learn more about the process? Find out using the link
              below.
            </p>
          </div>
